            ...
            <div class="bg-white rounded-lg shadow-lg p-4 md:w-[50rem]">
                ...
                <div>
                    <div class="flex justify-end">
                        ...
                        <!-- <span class="px-2 text-sm font-medium text-gray-800 bg-red-100 rounded-full">Dado de baja</span> -->
                    </div>
                    <div class="ml-2 md:ml-5 p-2 pt-5">
                        <h2 class="font-bold">Domicilio: <p class="font-normal">{{$dato->nombreColonia . ', ' . $dato->calle. ', ' . $dato->num}}
                        </p></h2>
                        <h2 class="font-bold">Ciudad: <p class="font-normal">{{$dato->nombreMunicipio }}
                        </p></h2>
                        <h2 class="font-bold">Nombre empleado: <span class="font-normal">{{$dato->nombreEmpleado}}</span></h2>
                        <h2 class="font-bold">Telefono: <span class="font-normal">{{$dato->telefono}}</span></h2>
                ...
                <div class="flex justify-between md:mt-16 mt-10">
                    ...
                    <div class="mr-10">
                    <form action="{{ route('empleado.baja', ['pkEmpleado' => $dato->pkEmpleado]) }}" method="POST">
                        @csrf
