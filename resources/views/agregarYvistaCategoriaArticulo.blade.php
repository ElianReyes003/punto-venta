        ...
        <div class="p-4">
           ...
           <a href="{{ url('/articulesList') }}" class="flex items-center bg-blue-500 p-2 text-base font-medium text-white rounded-lg hover:bg-blue-400">
            ...
            <div>
                    ...
                    <input  name="nombreCategoriaArticulo" type="text" id="" class="bg-blue-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-400 focus:border-blue-400 block w-full p-2.5" placeholder="" required>
                </div>
            ...
            <div class="flex justify-center	mt-5">
				<div class="md:p-10 p-5">
					  <div class="flex">
						<!-- Previous Button -->
						<a href="{{ url('/articulesList') }}"class="flex items-center justify-center px-4 h-10 md:px-10 md:mr-20 mr-10 text-base font-medium text-white bg-blue-500 border rounded-lg hover:bg-blue-400">
						  Cancelar
						</a>
						<!-- Next Button -->
						...
						<tr class="h-20">
							...
							<td class="items-center flex justify-center">
                                <div class="flex justify-between">
                                    <a href="{{route('categoriaArticulo.mostrarPorId', $dato->pkCategoriaArticulo)}}" class="flex mr-5 w-11 h-11 items-center mt-2 bg-blue-500 p-2 text-base font-medium text-white rounded-lg hover:bg-blue-400">
                                    ...
                                    <form action="{{ route('categoriaArticulo.baja', ['pkArticulo' => $dato->pkCategoriaArticulo]) }}" method="POST">
