...
<div class="p-4 sm:ml-64 mt-16 md:mt-10">
        ...
        <div class="p-4">
		   ...
		   <div class="flex justify-center">
            ...
            @csrf    
            <h1 class="text-center font-bold text-2xl p-5">Editar Ciudad</h1>
                <div class="gap-6 p-5">
                    <div>
                        <label for="" class="block mb-2 text-sm font-medium text-gray-900">Ciudad</label>
                        <input  name="nombreMunicipio" id="nombreMunicipio" value="{{$datosMunicipio->nombreMunicipio}}" required id="" class="bg-blue-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-400 focus:border-blue-400 block w-full p-2.5" placeholder="" required>
                    </div>
