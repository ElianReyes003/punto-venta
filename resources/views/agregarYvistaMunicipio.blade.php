        ...
        <div class="p-4">
		   ...
		   <div class="bg-white rounded-lg shadow-lg p-4">
            ...
            <div>
                    ...
                    <input  name="nombreMunicipio"  type="text" id="" class="bg-blue-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-400 focus:border-blue-400 block w-full p-2.5" placeholder="" required>
                </div>
           ...
           <div class="flex mt-10 md:mr-10 p-5">
                        <a href="/coloniaVision" class="flex items-center bg-blue-500 p-2 text-base font-medium text-white rounded-lg hover:bg-blue-400">
            ...
            <div class="flex justify-center">
				<h1 class="text-center font-bold md:text-[2rem] mt-5">Lista de Municipios</h1>
			</div>
						...
						<tr class="h-20">
							...
							<td class="items-center flex justify-center">
                                <div class="flex justify-between">
                                    <a href="{{route('municipio.mostrarPorId', $dato->pkMunicipio)}}" class="flex mr-5 w-11 h-11 items-center mt-2 bg-blue-500 p-2 text-base font-medium text-white rounded-lg hover:bg-blue-400">
                                    ...
                                    <form action="{{ route('municipio.baja', $dato->pkMunicipio) }}" method="POST" class="inline">
                                        @csrf
