        ...
        <div class="p-4">
		   ...
		   <div class="flex justify-center">
            ...
            <h1 class="text-center font-bold text-2xl p-5">Editar colonia</h1>
                    <!-- <select name="fkMunicipio" class="fkMunicipio" id="fkMunicipio">
                        @php
                ...
                <div class="gap-6 p-5">
                    ...
                    <div>
                        ...
                        <input   type="text" name="nombreColonia" id="nombreColonia" value="{{$datosColonia->nombreColonia}}" required id="" class="bg-blue-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-400 focus:border-blue-400 block w-full p-2.5" placeholder="" required>
                    </div>
